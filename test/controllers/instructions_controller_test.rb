...
class InstructionsControllerTest < ActionController::TestCase
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post :create, instruction: { axis_mode: @instruction.axis_mode, description: @instruction.description, motion_id: @instruction.motion_id, order_no: @instruction.order_no }
    end
  ...
  test "should update instruction" do
    patch :update, id: @instruction, instruction: { axis_mode: @instruction.axis_mode, description: @instruction.description, motion_id: @instruction.motion_id, order_no: @instruction.order_no }
    assert_redirected_to instruction_path(assigns(:instruction))
  end
